...
MySQL - 10.4.22-MariaDB : Database - parcial_1
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`parcial_1` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `academicperiodgroups` (
  ...
  KEY `groupId` (`groupId`),
  KEY `academicperiodgroups_ibfk_1` (`journeyId`),
...
insert  into `academicperiodgroups`(`id`,`name`,`journeyId`,`degreeId`,`groupId`,`quota`) values 
(62,'',16,23,10,30),
(63,'',16,24,10,30),
(64,'',16,25,10,30),
(65,'',16,26,10,30),
...
(23,'Kínder',NULL,'2021-11-19 20:14:43',NULL,11),
(24,'Preparatoria',NULL,'2021-11-19 20:15:05',NULL,11),
(25,'Primero Primaria\r\n',NULL,'2021-11-19 20:15:15',NULL,11),
(26,'Segundo Primaria',NULL,'2021-11-19 20:15:21',NULL,11),
(27,'Tercero Primaria',NULL,'2021-11-19 20:15:46',NULL,12),
(28,'Cuarto Primaria',NULL,'2021-11-19 20:15:52',NULL,12),
(29,'Quinto Primaria',NULL,'2021-11-19 20:15:58',NULL,12),
(30,'Sexto Primaria',NULL,'2021-11-19 20:16:04',NULL,12),
(31,'Primero Básico\r\n',NULL,'2021-11-19 20:16:48',NULL,13),
(32,'Segundo Básico\r\n',NULL,'2021-11-19 20:16:55',NULL,13);
...
insert  into `groups`(`id`,`name`,`abbreviation`,`updatedAt`,`createdAt`) values 
(10,'Sección A','A',NULL,'2021-11-19 19:44:22');
...
insert  into `journeys`(`id`,`name`,`createdAt`,`updatedAt`,`abbreviation`) values 
(16,'Matutina','2021-11-19 19:42:18',NULL,'Mat.\r\n');
...
(11,'Preprimaria y Primaria Baja',NULL,'2022-03-16 20:05:59',NULL),
(12,'Primaria Alta',NULL,'2021-11-19 20:15:35',NULL),
(13,'Secundaria',NULL,'2021-11-19 20:16:39',NULL);
